 ...
 <div class="bg-gray-100">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
      <h2 class="text-6xl font-bold text-gray-900">Category</h2><br/>
      ...
      <div class="mt-6 space-y-12 lg:grid lg:grid-cols-4 lg:gap-x-6 lg:space-y-0">
        ...
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Mains</p>
        </div>
        </router-link>
        ...
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Pastrys</p>
        </div>
        </router-link>
        ...
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Drinks</p>
        </div>
        </router-link>
