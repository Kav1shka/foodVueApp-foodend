  ...
  const products = [
    {
      ...
      name: 'Coca cola',
      href: '#',
      imageSrc: 'https://aglorycashandcarry.com/wp-content/uploads/2021/10/coca-cola-bottle-330-ml-1000x1000-1.jpg',
    ...
    },
    {
      ...
      name: 'Sprite',
      href: '#',
      imageSrc: 'https://m.media-amazon.com/images/I/61-x2JsEZVL._SL1500_.jpg',
      imageAlt: "Front of men's Basic Tee in black.",
      price: 'Rs 100'
    },
    {
